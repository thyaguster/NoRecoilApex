...
Gui Show, w345 h400, No Recoil Script v2.1
Gui, Color, Grey
Gui, Font, cWhite
Gui, Font, s12
Gui Add, Text, x0 y8 w343 h20 Center, Apex Legends No Recoil Script v2.1
Gui, Font, s10
Gui Add, GroupBox, x18 y32 w190 h295, Hotkeys
...
Gui Add, Text, x32 y230 w158 h16, [ %key_m249% ] Havoc
Gui Add, Text, x32 y254 w109 h16, [ %key_RCoff% ] Disable Script
Gui Add, Text, x32 y270 w111 h16, [ %key_Terminate% ] Close Script
Gui Add, Text, x32 y284 w140 h16, [ %key_pause% ] Pause Script
Gui Add, Text, x32 y298 w140 h16, [ %key_freemode% ] Autofire On/Off
Gui Font, s8
...
Gui Add, Text, x80 y304 w102 h20, Havoc
Gui Add, Text, x80 y328 w102 h20, Disable Script
Gui Add, Text, x80 y352 w102 h20, Close Script
Gui Add, Text, x80 y376 w102 h20, Pause Script
Gui Add, Text, x80 y400 w102 h20, Autofire On/Off
...
Gui Add, Edit, x32 y304 w40 h20 vkey_m249, %key_m249%
Gui Add, Edit, x32 y328 w40 h20 vrCoff, %key_rCoff%
Gui Add, Edit, x32 y352 w40 h20 vkey_terminate, %key_terminate%
Gui Add, Edit, x32 y376 w40 h20 vkey_pause, %key_pause%
Gui Add, Edit, x32 y400 w40 h20 vkey_freemode, %key_freemode%
...
Gui Add, GroupBox, x16 y16 w173 h417, Hotkeys Configuration
