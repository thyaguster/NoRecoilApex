...
Gui, Font, s10
Gui Add, GroupBox, x18 y32 w190 h280, Hotkeys
Gui Add, GroupBox, x214 y32 w122 h89, Settings
...
Gui Add, Text, x32 y272 w140 h16, [ %key_freemode% ] Autofire On/Off
Gui Font, s8
...
Gui Add, Text, x80 y352 w102 h20, Autofire On/Off
...
Gui Add, Edit, x32 y352 w40 h20 vkey_freemode, %key_freemode%
Gui Add, Edit, x288 y40 w31 h21 vsens, %sens%
Gui Add, Edit, x288 y88 w31 h21 vdpi, %dpi%
...
Gui Add, Text, x224 y88 w57 h20, DPI:
...
Gui Add, GroupBox, x16 y16 w173 h378, Hotkeys Configuration
...
IniWrite, "%dpi%", settings.ini, mouse settings, dpi
